...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for position in self.allPositions:
            self.beliefs[position]=self.beliefs[position]*self.getObservationProb(observation,pacPosition,position,jailPosition)
        self.beliefs.normalize()
    ...
    def elapseTime(self, gameState):
        ...
        for oldPosition in self.allPositions:
            ...
            for newPos,newProb in newPosDist.items():
                tempVar[newPos] += old_prob * newProb
        self.beliefs = tempVar
